...
# #Напишіть програму на Python, яка використовує цикл while для обчислення суми квадратів чисел від 1 до N. 
# Число N ви задаєте в коді як сталу, наприклад, N = 10.
# Цикл while повинен виконати ітерації від 1 до N. 
# Визначте <умову> циклу while щоб буди виконані все ітерації від 1 до N. 
# На кожній ітерації додайте квадрат поточного числа i до загальної суми sum_squares (Підказка: квадрат числа це i помножене на само себе). 
# Також збільшуйте поточне число i на кожній ітерації на одиницю, щоб сума правильно порахувалась.
# Якщо N = 10, виведення має бути: The sum of the squares of numbers from 1 to 10 is 385.
